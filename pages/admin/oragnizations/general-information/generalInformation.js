export class GeneralInformationPage {
    constructor(page){
        ...
        this.registrationNumberInputField = page.locator('(//div[@class="oxd-input-group oxd-input-field-bottom-space"])[2]/div[2]');
        ...
        this.countryDropdownButton = page.locator('//div[@role="listbox"]');
    ...
    async editGenerationalInformation(organizationName,employeeNumber,registrationNumber,taxIdNumber,phoneNumber,faxNumber,email,address1,address2,cityName,stateName,zipCode,country){
        ...
        await this.numberofEmployeesInputField.fill(employeeNumber)
        ...
        await this.addressFieldInputField2.flil(address2);
