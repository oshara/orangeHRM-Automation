...
export const deleteMembershipFunc = async(page)=>{
    ...
    const membershipPageObj = new MembershipsPage(page);
    await membershipPageObj.deleteMembership('British Computer Society (BCS)')
}